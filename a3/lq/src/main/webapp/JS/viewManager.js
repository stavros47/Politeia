...
function showRegistrationForm () {
        ...
        var main = document.getElementById('mainContent');
                ...
                var registration =  [    
                        '<form id="lqForm" onSubmit="return ValidateInputs()">',
                                 ...
                                 '<div class="form-group row has-success has-feedback">',
                                         '<div class="col-md-6">',
                                                 ...
                                                 '<input type="password" class="form-control" id="InputPassword" placeholder="Password" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,10}$" title="Make sure it\'s between 8-10 characters. You must use at least ONE letter, ONE number and ONE symbol (e.x: #,!,$,% etc)" name="password">',
                                         ...
                                         '<div class="col-md-6">',
                                                 ...
                                                 '<input type="password" class="form-control" id="InputPassword2" placeholder="Password" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,10}$" title="Make sure it\'s between 8-10 characters. You must use at least ONE letter, ONE number and ONE symbol (e.x: #,!,$,% etc)" name="confirmPassword">',
                                 ...
                                 '<div class="form-group">',
                                        ...
                                        '<!-- Added a fallback pattern regex validation because browsers that do not support type="date" will convert it to type="text"',
                                         ...
                                         '-->',
                                         '<input type="date" class="form-control" id="InputDOB" pattern="" name="DOB">',
                                 '</div>',
                                ...
                                '</div>',
                                 ...
                                 '<div class="form-group has-success has-feedback">',
                                         ...
                                         '<input type="text" class="form-control" id="InputProffession" pattern=".{2,20}" title="Must be between 2 - 20 characters long." placeholder="Profession" name="profession">',
